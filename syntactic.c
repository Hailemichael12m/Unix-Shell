...
token_types* save_mycommands(char* command_name, char* pipe_token, 
char* redir_in_token, char* redir_out_token, 
char* background_token, DynArray_T normal_token){
...
int synAnalysis(DynArray_T oTokens, DynArray_T new_token, char *synt){
    ...
    enum SynState{STATE_START, STATE_WORD, STATE_PIPE, 
        STATE_RED_IN, STATE_RED_OUT, STATE_BACKGROUND};
